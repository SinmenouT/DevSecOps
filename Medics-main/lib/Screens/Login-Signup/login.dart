    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(children: [
          ...
          Auth_text_field(text: "Entrer votre email", icon: "lib/icons/email.png"),
          const SizedBox(
            height: 5,
          ),
          //Text field Password
          ...
          auth_social_logins(
              logo: "images/google.png", text: "Connexion avec Google"),
          const SizedBox(
            height: 20,
          ),
          auth_social_logins(logo: "images/apple.png", text: "Connexionavec Apple"),
          const SizedBox(
            height: 20,
          ),
          auth_social_logins(
              logo: "images/facebook.png", text: "Connexion avec facebook")
        ]),
      ),
    );
  }
